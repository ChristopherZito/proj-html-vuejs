  ...
  <div id="container">
      <section id="middle">
            ...
            <section id="up-main">
                ...
                <hr>
                <!-- immagini  img/title/date/comments/description -->
                <div class="box" >
                    <div :class="item.position == `top` ? `items` : `none`" v-for="item,i in products" :key="i">
                        <div class="img">
            ...
            <section id="more-info">
                ...
                <h1>Cras malesuada er orci eget pharetra</h1>
                <!-- text -->
